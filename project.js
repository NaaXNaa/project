...
perpustakaan.tambah("risdho", "risolmayo", 1234, "Fantasi");
perpustakaan.tambah("anfinanakjalanan", "Phutrajawir", 1945, "isekai");
perpustakaan.tambah("hippopembuatartikel", "hippotamus", 2009, "Horor");
perpustakaan.semuaBuku();
perpustakaan.edit(1, "hippopembuatartikel");
perpustakaan.semuaBuku();
